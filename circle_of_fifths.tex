...
\foreach \Note/\X in {C/0,G/1,D/2,A/3,E/4,B/5,G$\flat$/6,D$\flat$/-5,A$\flat$/-4,E$\flat$/-3,B$\flat$/-2,F/-1}
    {
    \foreach \dX/\Y in {-0.33/\ChordsR,0.33/\ChordsR,0.25/{\ChordsR-1},0/{\ChordsR-3}}
        {
...
% \foreach \Note/\X/\Y in {C/-0.33/\rootY,G/1.25/\fifthY,E/4.33/\thirdY,B/5/\seventhY}
%     {
%     \draw(90-\X*360/12:\Y) node [align=center, rotate=-\X*360/12] {\Note};
%     }
