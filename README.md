...
* *mode*: a scale of notes with one key starting at a certain note within that key, each mode with its own "characteristic melodic and harmonic behavior" (loosely from <https://en.wikipedia.org/wiki/Mode_(music)>)
